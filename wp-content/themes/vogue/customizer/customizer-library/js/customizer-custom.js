    ...
    $( window ).load( function() {
        ...
        function vogue_customizer_slider_check( slider_select_value ) {
            if ( slider_select_value == 'vogue-slider-default' ) {
                ...
                $( '#accordion-section-vogue-slider-section #customize-control-vogue-slider-scroll-effect' ).show();
                ...
                $( '#accordion-section-vogue-slider-section #customize-control-vogue-slider-scroll-effect' ).hide();
