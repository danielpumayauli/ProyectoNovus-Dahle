        ...
        <div class="site-container">
        	...
        	<?php if ( ! get_theme_mod( 'vogue-footer-hide-social' ) ) : ?>
				...
				if ( !get_theme_mod( 'vogue-social-email', false ) && 
					...
					echo '<a class="footer-social-icon footer-social-email"><i class="fa fa-envelope-o"></i></a><a class="footer-social-icon footer-social-facebook"><i class="fa fa-facebook"></i></a><a class="footer-social-icon footer-social-twitter"><i class="fa fa-twitter"></i><span>' . __( '+ more', 'vogue' ) . '</span></a>';
				} ?>
